...
type: source
tags: ["agent", "prompt", "rag", "mcp", "model context", "pdf"]
...
Agent Skills are [supported today](https://www.anthropic.com/news/skills) across [Claude.ai](http://claude.ai/redirect/website.v1.5593aa77-4bc8-4af3-ba29-d644c38e124c), Claude Code, the Claude Agent SDK, and the Claude Developer Platform.

...
### 与 LLM 集成
如果 [[concepts/llm]] 为 wiki 页面添加 YAML frontmatter（如标签、日期、源计数），Dataview 可以：
1. **自动分类**：按类型、标签等组织页面
...
## References
- [[entities/obsidian]] - Dataview 的运行平台
- [[concepts/llm-wiki]] - 应用 Dataview 的知识管理系统
- [[concepts/wikilinks]] - frontmatter 查询的链接基础
---
title: "学习 Kubernetes 流量管理之 Ingress"
source: "https://www.aneasystone.com/archives/2023/11/kubernetes-traffic-management-ingress.html"
author:
published:
created: 2026-04-30
description: "在 学习 Kubernetes 流量管理之 Service 这篇笔记中我们学习了 Kubernetes 是如何使用 Service 进行流量管理的，我们可以通过 NodePort 和 LoadB..."
tags:
  - "clippings"
---
在 [学习 Kubernetes 流量管理之 Service](https://www.aneasystone.com/archives/2023/10/kubernetes-traffic-management-service.html) 这篇笔记中我们学习了 Kubernetes 是如何使用 Service 进行流量管理的，我们可以通过 `NodePort` 和 `LoadBalancer` 这两种类型的 Service 让应用程序暴露到集群外部，不过这两种方式都有各自的问题：
...
![ingress.png](https://www.aneasystone.com/usr/uploads/2023/11/372128578.png "ingress.png")
...
![ingress-simple-fanout.png](https://www.aneasystone.com/usr/uploads/2023/11/3990323063.png "ingress-simple-fanout.png")
...
![ingress-virtual-host.png](https://www.aneasystone.com/usr/uploads/2023/11/2466860092.png "ingress-virtual-host.png")

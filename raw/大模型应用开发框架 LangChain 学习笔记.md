---
title: "大模型应用开发框架 LangChain 学习笔记"
source: "https://www.aneasystone.com/archives/2023/08/llm-application-frameworks-langchain.html"
author:
published:
created: 2026-04-30
description: "一场关于大模型的战役正在全世界激烈地上演着，国内外的各大科技巨头和研究机构纷纷投入到这场战役中，光是写名字就能罗列出一大串，比如国外的有 OpenAI 的 GPT-4，Meta 的 LLaMa，..."
tags:
  - "clippings"
---
...
在 [基于 ChatGPT 实现一个划词翻译 Chrome 插件](https://www.aneasystone.com/archives/2023/06/chrome-extension-with-chatgpt.html) 这篇笔记中，我们通过提示语技术实现了一个非常简单的划词翻译 Chrome 插件，其中的翻译功能我们也可以使用 LangChain 来完成，当然，使用 `LLMs` 和 `ChatModels` 都可以。
...
在 [使用 Embedding 技术打造本地知识库助手](https://www.aneasystone.com/archives/2023/07/doc-qa-using-embedding.html) 这篇笔记中，我们通过 OpenAI 的 Embedding 接口和开源向量数据库 Qdrant 实现了一个非常简单的知识库助手。在上面的介绍中我们提到，LangChain 的一大特点就是数据感知，可以将语言模型和其他来源的数据进行连接，所以知识库助手正是 LangChain 最常见的用例之一，这一节我们就使用 LangChain 来重新实现它。
...
![data-connection.jpg](https://www.aneasystone.com/usr/uploads/2023/08/1888110135.jpg "data-connection.jpg")
...
后面的步骤就和 [使用 Embedding 技术打造本地知识库助手](https://www.aneasystone.com/archives/2023/07/doc-qa-using-embedding.html) 这篇笔记中一样，准备一段提示词模板，向 ChatGPT 提问就可以了。
...
![stuff-documents.jpg](https://www.aneasystone.com/usr/uploads/2023/08/3710167477.jpg "stuff-documents.jpg")
...
![refine-documents.jpg](https://www.aneasystone.com/usr/uploads/2023/08/1609985190.jpg "refine-documents.jpg")
...
![map-reduce-documents.jpg](https://www.aneasystone.com/usr/uploads/2023/08/1721671700.jpg "map-reduce-documents.jpg")
...
![map-rerank-documents.jpg](https://www.aneasystone.com/usr/uploads/2023/08/3356778003.jpg "map-rerank-documents.jpg")
...
本文所有的源码可以 [参考这里](https://github.com/aneasystone/weekly-practice/tree/main/notes/week043-llm-application-frameworks-langchain/demo) 。

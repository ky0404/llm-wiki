...
![day-of-the-week.png](https://www.aneasystone.com/usr/uploads/2023/09/1936719625.png "day-of-the-week.png")
...
![chatgpt-4-plugins.png](https://www.aneasystone.com/usr/uploads/2023/09/1541718087.png "chatgpt-4-plugins.png")
...
![day-of-the-week-with-plugins.png](https://www.aneasystone.com/usr/uploads/2023/09/1924664027.png "day-of-the-week-with-plugins.png")

从对话的结果中可以看到 ChatGPT 使用了 Wolfram 插件，展开插件的调用详情还可以看到调用的请求和响应：

![wolfram-detail.png](https://www.aneasystone.com/usr/uploads/2023/09/2830477279.png "wolfram-detail.png")
...
> 在 [基于 ChatGPT 实现一个划词翻译 Chrome 插件](https://www.aneasystone.com/archives/2023/06/chrome-extension-with-chatgpt.html) 这篇笔记中，我们已经学习过 OpenAI 的 Chat Completions API，感兴趣的同学可以复习下。
...
可以从 [load\_tools.py](https://github.com/langchain-ai/langchain/blob/master/libs/langchain/langchain/agents/load_tools.py) 源码中找到支持的工具列表。
...
很显然，这个 Agent 是基于 OpenAI 的 Function Calling 实现的，它通过 `format_tool_to_openai_function()` 将 LangChain 的工具转换为 OpenAI 的 `functions` 参数。但是 Function Calling 机制只有 OpenAI 的接口才支持，而 LangChain 面对的是各种大模型，并不是所有的大模型都支持 Function Calling 机制，这是要专门训练的，所以 LangChain 的 Agent 还需要支持一种更通用的实现机制。根据所使用的策略，LangChain 支持 [多种不同的 Agent 类型](https://python.langchain.com/docs/modules/agents/agent_types/) ，其中最通用，也是目前最流行的 Agent 是基于 ReAct 的 Agent。
...
![react.png](https://www.aneasystone.com/usr/uploads/2023/09/1532086278.png "react.png")
...
![agent.png](https://www.aneasystone.com/usr/uploads/2023/09/330686760.png "agent.png")

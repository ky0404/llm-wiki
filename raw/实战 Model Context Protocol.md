...
source: "https://www.aneasystone.com/archives/2025/03/mcp-in-action.html"
author:
published:
created: 2026-04-30
description: "2024 年 11 月 25 日，Anthropic，就是 Claude 背后的那家公司，推出了一个名为 MCP 的开放协议，它的全称为 Model Context Protocol（模型上下文..."
tags:
  - "clippings"
---
...
![mcp-overview.png](https://www.aneasystone.com/usr/uploads/2025/03/1984037284.png "mcp-overview.png")
...
![mcp-vs-api.png](https://www.aneasystone.com/usr/uploads/2025/03/1687246064.png "mcp-vs-api.png")
...
![claude-hi.png](https://www.aneasystone.com/usr/uploads/2025/03/3323372231.png "claude-hi.png")

然后，打开 `Settings` -> `Developer` 配置页面：

![claude-settings.png](https://www.aneasystone.com/usr/uploads/2025/03/3739475441.png "claude-settings.png")
...
![claude-mcp-hammer.png](https://www.aneasystone.com/usr/uploads/2025/03/4181183027.png "claude-mcp-hammer.png")

点击小图标，可以看到 Filesystem MCP Server 自带的所有工具列表：

![claude-mcp-tools.png](https://www.aneasystone.com/usr/uploads/2025/03/1548500659.png "claude-mcp-tools.png")

这时我们就可以在对话时让 Claude 调用这些工具了：

![claude-file-list.png](https://www.aneasystone.com/usr/uploads/2025/03/3036146103.png "claude-file-list.png")
...
![claude-mcp-my-tools.png](https://www.aneasystone.com/usr/uploads/2025/03/2455772600.png "claude-mcp-my-tools.png")

测试下效果：

![claude-using-my-tools.png](https://www.aneasystone.com/usr/uploads/2025/03/1345401497.png "claude-using-my-tools.png")
...
上面我们体验了在 Claude Desktop 中通过 MCP Server 让大模型调用外部工具，实现更强大的功能，这很容易让人想起智能体的概念。智能体是目前最热门最前沿的研究方向之一，我曾在之前的博客中多次学习过相关的技术，比如在 [大模型应用开发框架 LangChain 学习笔记（二）](https://www.aneasystone.com/archives/2023/09/llm-application-frameworks-langchain-2.html) 中学习 OpenAI 的 Function Call 功能以及 LangChain 内置的几种 Agent 的使用，在 [基于 LangGraph 创建智能体应用](https://www.aneasystone.com/archives/2024/10/create-agents-with-langgraph.html) 中学习如何使用 LangGraph 开发智能体应用。
...
![mcp-inspector.png](https://www.aneasystone.com/usr/uploads/2025/03/707048602.png "mcp-inspector.png")

在这里可以查看 MCP Server 的工具列表，也可以对工具进行调用。除了工具，也支持资源、提示以及其他功能的调试。

在页面左下方，可以查看调试的历史记录：

![mcp-inspector-history.png](https://www.aneasystone.com/usr/uploads/2025/03/3986768419.png "mcp-inspector-history.png")
...
![mcp-lifecycle.png](https://www.aneasystone.com/usr/uploads/2025/03/3178010827.png "mcp-lifecycle.png")

---
title: "学习 Kubernetes 流量管理之 Service"
source: "https://www.aneasystone.com/archives/2023/10/kubernetes-traffic-management-service.html"
author:
published:
created: 2026-04-30
description: "在 Kubernetes 使用小记 这篇笔记中我们学习了 Kubernetes 的基本用法和概念，通过 Deployment 部署应用程序，然后通过 Service 将应用程序暴露给其他人访问。..."
tags:
  - "clippings"
---
在 [Kubernetes 使用小记](https://www.aneasystone.com/archives/2022/06/playing-with-kubernetes.html) 这篇笔记中我们学习了 Kubernetes 的基本用法和概念，通过 Deployment 部署应用程序，然后通过 Service 将应用程序暴露给其他人访问。其中 Service 是 Kubernetes 最基础的流量管理机制之一，它的主要目的有：
...
![endpoint-slices.png](https://www.aneasystone.com/usr/uploads/2023/10/2666105477.png "endpoint-slices.png")
...
在 [Kubernetes 使用小记](https://www.aneasystone.com/archives/2022/06/playing-with-kubernetes.html) 这篇笔记中我们了解到， `Service` 有如下几种类型：
...
![service-type-clusterip.png](https://www.aneasystone.com/usr/uploads/2023/10/1286634047.png "service-type-clusterip.png")
...
![service-type-nodeport.png](https://www.aneasystone.com/usr/uploads/2023/10/2629813392.png "service-type-nodeport.png")
...
![service-type-loadbalancer.png](https://www.aneasystone.com/usr/uploads/2023/10/383196665.png "service-type-loadbalancer.png")
...
![kube-proxy-userspace.png](https://www.aneasystone.com/usr/uploads/2023/10/3863519414.png "kube-proxy-userspace.png")
...
![kube-proxy-iptables.png](https://www.aneasystone.com/usr/uploads/2023/10/2072999917.png "kube-proxy-iptables.png")
...
![kube-proxy-ipvs.png](https://www.aneasystone.com/usr/uploads/2023/10/2483804012.png "kube-proxy-ipvs.png")
...
2. [Kubernetes 教程 | Kuboard](https://kuboard.cn/learning/k8s-intermediate/service/service-details.html)
3. [Kubernetes 练习手册](https://k8s-tutorials.pages.dev/service.html)
4. [Service - Kubernetes 指南](https://kubernetes.feisky.xyz/concepts/objects/service)
5. [Service · Kubernetes 中文指南](https://jimmysong.io/kubernetes-handbook/concepts/service.html)
6. [数据包在 Kubernetes 中的一生（1）](https://blog.fleeto.us/post/life-of-a-packet-in-k8s-1/)
7. [Kubernetes（k8s）kube-proxy、Service详解](https://www.cnblogs.com/liugp/p/16372503.html)
8. [华为云在 K8S 大规模场景下的 Service 性能优化实践](https://zhuanlan.zhihu.com/p/37230013)
9. [Kubernetes 从1.10到1.11升级记录(续)：Kubernetes kube-proxy开启IPVS模式](https://blog.frognew.com/2018/10/kubernetes-kube-proxy-enable-ipvs.html)
10. [浅谈 Kubernetes Service 负载均衡实现机制](https://xigang.github.io/2019/07/21/kubernetes-service/)
11. [八 Service 配置清单](https://zeusro-awesome-kubernetes-notes.readthedocs.io/zh_CN/latest/chapter_8.html)
12. [Scaling Kubernetes Networking With EndpointSlices](https://kubernetes.io/blog/2020/09/02/scaling-kubernetes-networking-with-endpointslices/)
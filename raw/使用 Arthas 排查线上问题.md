---
title: "使用 Arthas 排查线上问题"
source: "https://www.aneasystone.com/archives/2023/09/trouble-shooting-with-arthas.html"
author:
published:
created: 2026-04-30
description: "Arthas 是阿里开源的一款 Java 应用诊断工具，可以在线排查问题，动态跟踪 Java 代码，以及实时监控 JVM 状态。这个工具的大名我早有耳闻，之前一直听别人推荐，却没有使用过。最近在..."
tags:
  - "clippings"
---
...
在 [细数 JDK 自带的那些调试和诊断工具](https://github.com/aneasystone/weekly-practice/blob/main/notes/week028-jvm-diagnostic-tools/README.md) 这篇笔记中我总结了很多 JDK 自带的诊断工具，其实有很多 Arthas 命令和那些 JDK 工具的功能是类似的，只是 Arthas 在输出格式上做了优化，让输出的内容更加美观和易读，而且在功能上做了增强。
...
在 [Spring Boot 生产就绪特性 Actuator](https://www.aneasystone.com/archives/2022/07/spring-boot-actuator.html) 这篇笔记中，我们学习过 Spring Boot Actuator 内置了一个 `/loggers` 端点，可以查看或修改 logger 的日志等级，比如下面这个 POST 请求将 `com.example.demo` 的日志等级改为 `DEBUG` ：

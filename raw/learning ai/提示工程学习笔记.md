...
created: 2026-04-29
description: "在之前的笔记中，我们学习了很多大模型的使用技巧，比如 实现一个划词翻译插件、实现基于文档的问答助手、实现基于数据库的问答助手 等等，在这些使用场景中，我们应该都或多或少听过 提示工程（Promp..."
tags:
  - "clippings"
---
在之前的笔记中，我们学习了很多大模型的使用技巧，比如 [实现一个划词翻译插件](https://www.aneasystone.com/archives/2023/06/chrome-extension-with-chatgpt.html) 、 [实现基于文档的问答助手](https://www.aneasystone.com/archives/2023/07/doc-qa-using-embedding.html) 、 [实现基于数据库的问答助手](https://www.aneasystone.com/archives/2023/11/structured-data-qa.html) 等等，在这些使用场景中，我们应该都或多或少听过 **提示工程（Prompt Engineering）** 这个概念；另外，在 [大模型应用开发框架 LangChain 学习笔记（二）](https://www.aneasystone.com/archives/2023/09/llm-application-frameworks-langchain-2.html) 这篇笔记中，我们学习了什么是 **智能体（Agent）** ，并使用 LangChain 实现了几种不同类型的智能体，将提示工程技术发挥得淋漓尽致。那么到底什么是提示工程呢？提示工程又有哪些使用技巧呢？这篇笔记就来系统地学习下相关知识。
...
![zero-cot.png](https://www.aneasystone.com/usr/uploads/2024/01/69203959.png "zero-cot.png")

这么简单的一句话，竟然可以起到这么大的作用，着实让人意想不到。有趣的是，论文中还尝试了不少其他的提示词，最终发现 Let's think step by step. 效果最好：

![zero-cot-exaples.png](https://www.aneasystone.com/usr/uploads/2024/01/3910736317.png "zero-cot-exaples.png")
...
![self-consistency.png](https://www.aneasystone.com/usr/uploads/2024/01/56633644.png "self-consistency.png")
...
![zero-cot-stages.png](https://www.aneasystone.com/usr/uploads/2024/01/3825668424.png "zero-cot-stages.png")
...
![step-back.png](https://www.aneasystone.com/usr/uploads/2024/02/3542434150.png "step-back.png")
...
![rag.png](https://www.aneasystone.com/usr/uploads/2024/01/1815602446.png "rag.png")
...
![knowledge.png](https://www.aneasystone.com/usr/uploads/2024/01/3660396963.png "knowledge.png")
...
![ape.png](https://www.aneasystone.com/usr/uploads/2024/01/1461831168.png "ape.png")
...
![ape-zero-shot-cot.png](https://www.aneasystone.com/usr/uploads/2024/01/1042051591.png "ape-zero-shot-cot.png")
...
![active-prompt.png](https://www.aneasystone.com/usr/uploads/2024/01/1644817368.png "active-prompt.png")
...
![dsp.png](https://www.aneasystone.com/usr/uploads/2024/01/1640053020.png "dsp.png")
...
![dsp-example.png](https://www.aneasystone.com/usr/uploads/2024/01/3779372104.png "dsp-example.png")
...
- [OpenAI 官方提示工程指南](https://baoyu.io/translations/openai/openai-prompt-engineering-guides)

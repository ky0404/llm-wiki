---
title: "开源大模型 Llama 实战"
source: "https://www.aneasystone.com/archives/2024/04/llama-in-action.html"
author:
published: 2024-09-02
created: 2026-04-30
description: "去年 2 月 24 日，Facebook 的母公司 Meta AI 推出 Llama 语言模型，该模型完全使用公开可用的数据集进行训练，拥有 70 亿到 650 亿个参数，包括 7B、13B、3..."
tags:
  - "clippings"
---
...
![oss-llm.png](https://www.aneasystone.com/usr/uploads/2024/04/4141296701.png "oss-llm.png")
...
安装完成后，再次下载，这次虽然没有报错，但是模型的下载目录 pyllama\_data 却是空的，根据 [这里](https://github.com/juncongmoo/pyllama/issues/47) 的解决方案，我们使用源码重新安装 pyllama：
...
在深度学习的训练和推理过程中，我们常常会遇到单机多卡或多机多卡的情况，这就会涉及到各个卡或节点之间的通信，这种通信被称为 **集合通信（Collective Communication）** ，而 [NCCL](https://developer.nvidia.com/nccl) 就是这样的一个集合通信库，它是英伟达基于自家 NVIDIA GPU 定制开发的一套开源集合通信库，可以通过 PCIe 和 NVLink 等高速互联从而实现高带宽和低延迟。除了 NCCL，还有一些其他的库可以选择，比如 [MPI](https://www.mpi-forum.org/) 接口的开源实现 [Open MPI](https://www.open-mpi.org/) 、Facebook 的 [Gloo](https://github.com/facebookincubator/gloo) 等。
...
![llama2-latest.png](https://www.aneasystone.com/usr/uploads/2024/04/1290893705.png "llama2-latest.png")
...
![open-webui-login.png](https://www.aneasystone.com/usr/uploads/2024/04/1428975691.png "open-webui-login.png")

注册账号并登录后，就可以看到我们熟悉的聊天界面了：

![open-webui.png](https://www.aneasystone.com/usr/uploads/2024/04/3368555415.png "open-webui.png")

...
published:
created: 2026-04-30
description: "How to give clear and effective instructions to OpenAI models"
tags:
  - "clippings"
---
...
**Note**: There are some differences to consider when prompting a reasoning model versus prompting a GPT model. More details [here](https://platform.openai.com/docs/guides/text?api-mode=chat#prompting-reasoning-models).
...
3. `**max_completion_tokens**` (**maximum length)** - Does not control the length of the output, but a hard cutoff limit for token generation. Ideally you won’t hit this limit often, as your model will stop either when it thinks it’s finished, or when it hits a stop sequence you defined.

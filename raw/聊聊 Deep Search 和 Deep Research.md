...
source: "https://www.aneasystone.com/archives/2025/04/deep-search-and-research.html"
author:
published:
created: 2026-04-30
description: "2022 年 11 月 30 日，OpenAI 正式发布 ChatGPT 产品，仅两个月后，其月活用户就突破了 1 个亿，成为历史上增长最快的消费类应用之一。一时之间，生成式 AI 技术遍地开花..."
tags:
  - "clippings"
---
...
![chatgpt-search.png](https://www.aneasystone.com/usr/uploads/2025/04/3357124559.png "chatgpt-search.png")

国内外产商也纷纷跟进，比如 [DeepSeek](https://chat.deepseek.com/) 的：

![deepseek-search.png](https://www.aneasystone.com/usr/uploads/2025/04/2815976847.png "deepseek-search.png")

[Qwen Chat](https://chat.qwen.ai/) 的：

![qwen-search.png](https://www.aneasystone.com/usr/uploads/2025/04/3555643087.png "qwen-search.png")

[Kimi](https://kimi.moonshot.cn/) 的：

![kimi-search.png](https://www.aneasystone.com/usr/uploads/2025/04/3669872142.png "kimi-search.png")

[前不久](https://www.anthropic.com/news/web-search) ，Claude 也集成了搜索功能：

![claude-search.png](https://www.aneasystone.com/usr/uploads/2025/04/916120907.png "claude-search.png")
...
![baidu-ai+.png](https://www.aneasystone.com/usr/uploads/2025/04/3832654908.png "baidu-ai+.png")
...
![doc-qa.png](https://www.aneasystone.com/usr/uploads/2025/04/1232925714.png "doc-qa.png")

可以看出它的实现非常简单，唯一的难点是知识库文档和用户问题的向量化以及向量检索，而 **AI + 搜索** 则更简单，直接拿着用户问题去调搜索引擎的接口就行了：

![search-qa.png](https://www.aneasystone.com/usr/uploads/2025/04/152267886.png "search-qa.png")
...
![query-transformation.png](https://www.aneasystone.com/usr/uploads/2025/04/672623149.png "query-transformation.png")
...
![graph-qa.png](https://www.aneasystone.com/usr/uploads/2025/04/2925469153.png "graph-qa.png")
...
![agentic-rag-overview.png](https://www.aneasystone.com/usr/uploads/2025/04/2783154827.png "agentic-rag-overview.png")
...
![agentic-rag.png](https://www.aneasystone.com/usr/uploads/2025/04/3442960962.png "agentic-rag.png")
...
![grok-deep-search.png](https://www.aneasystone.com/usr/uploads/2025/04/3450413926.png "grok-deep-search.png")

在回答问题时会经过 **思考-搜索-分析-验证** 等步骤：

![grok-deep-search-2.png](https://www.aneasystone.com/usr/uploads/2025/04/42165784.png "grok-deep-search-2.png")
...
![jina-deep-search.png](https://www.aneasystone.com/usr/uploads/2025/04/1892015467.png "jina-deep-search.png")
...
![zilliz-deep-searcher.png](https://www.aneasystone.com/usr/uploads/2025/04/827983419.png "zilliz-deep-searcher.png")
...
![tiangong.png](https://www.aneasystone.com/usr/uploads/2025/04/777303051.png "tiangong.png")

再比如国内的 [秘塔](https://metaso.cn/) ：

![metaso.png](https://www.aneasystone.com/usr/uploads/2025/04/1149630098.png "metaso.png")

国外的 [Perplexity](https://www.perplexity.ai/) ：

![perplexity.png](https://www.aneasystone.com/usr/uploads/2025/04/289939486.png "perplexity.png")
...
![manus-usecases.png](https://www.aneasystone.com/usr/uploads/2025/04/488469386.png "manus-usecases.png")

下图是 [AutoGLM 沉思](https://autoglm-research.zhipuai.cn/) 的部分用例展示：

![autoglm-usecase.png](https://www.aneasystone.com/usr/uploads/2025/04/1861533441.png "autoglm-usecase.png")
...
![autoglm.jpg](https://www.aneasystone.com/usr/uploads/2025/04/2417605480.jpg "autoglm.jpg")

Gemini 的 Deep Research 功能可以结合思考模型和联网搜索对话题进行深度剖析：

![gemini-deep-research.png](https://www.aneasystone.com/usr/uploads/2025/04/1557276797.png "gemini-deep-research.png")

生成一份长达 7 页的 PDF 文件：

![gemini-deep-research-pdf.jpg](https://www.aneasystone.com/usr/uploads/2025/04/406577853.jpg "gemini-deep-research-pdf.jpg")

ChatGPT 的 Deep Research 在开始调研之前会先明确一下调研目标，之后开始搜索相关主题，经过长达 9 分钟的搜索后，生成了一份详实的报告：

![chatgpt-deep-research.png](https://www.aneasystone.com/usr/uploads/2025/04/1702360570.png "chatgpt-deep-research.png")

最近秘塔推出了一个 [生成互动网页](https://mp.weixin.qq.com/s/sk0KF9c1MPhpS2oGH-UIKA) 的功能，可以将搜索的内容整合成一份图文并茂的研究报告：

![metaso-report.png](https://www.aneasystone.com/usr/uploads/2025/04/309246680.png "metaso-report.png")
...
![gpt-researcher-overview.png](https://www.aneasystone.com/usr/uploads/2025/04/1752256627.png "gpt-researcher-overview.png")
...
![gpt-researcher-ui.png](https://www.aneasystone.com/usr/uploads/2025/04/147113489.png "gpt-researcher-ui.png")

新 UI 相对于老 UI 在左下角多了一个高级选项：

![gpt-researcher-ui-settings.png](https://www.aneasystone.com/usr/uploads/2025/04/2212161174.png "gpt-researcher-ui-settings.png")
...
![dzhng-deep-research-pdf.png](https://www.aneasystone.com/usr/uploads/2025/04/2634928831.png "dzhng-deep-research-pdf.png")

下面是大致的程序流程图：

![dzhng-deep-research-flow.png](https://www.aneasystone.com/usr/uploads/2025/04/3379483881.png "dzhng-deep-research-flow.png")

此外，有热心网友为这个程序做了 [Web 页面](https://github.com/AnotiaWang/deep-research-web-ui) ，你也可以 [在线体验](https://deep-research.ataw.top/) ：

![dzhng-deep-research-ui.png](https://www.aneasystone.com/usr/uploads/2025/04/156071657.png "dzhng-deep-research-ui.png")
...
![opendeepsearch-react.png](https://www.aneasystone.com/usr/uploads/2025/04/726508724.png "opendeepsearch-react.png")
...
![opendeepsearch-gradio-ui.png](https://www.aneasystone.com/usr/uploads/2025/04/1537080215.png "opendeepsearch-gradio-ui.png")

虽然这个项目的名字叫做 Deep Search，但是我觉得也可以将它划到 Deep Research 的范畴，主要在于它处理搜索结果的过程很值得学习，下面是调用 `OpenDeepSearchTool` 的流程图：

![opendeepsearch-flow.png](https://www.aneasystone.com/usr/uploads/2025/04/2676868159.png "opendeepsearch-flow.png")
...
![opendeepsearch-vs-others.png](https://www.aneasystone.com/usr/uploads/2025/04/1338258910.png "opendeepsearch-vs-others.png")
...
- [Github - langchain-ai/open\_deep\_research](https://github.com/langchain-ai/open_deep_research)
...
- [Github - binary-husky/gpt\_academic](https://github.com/binary-husky/gpt_academic)

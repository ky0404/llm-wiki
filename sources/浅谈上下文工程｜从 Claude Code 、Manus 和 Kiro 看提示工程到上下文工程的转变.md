...
type: source
tags: ["agent", "prompt", "llm", "rag", "langchain", "mcp", "langgraph"]
...
单从 *2025年10月24日 08:32*

![图片](https://mmbiz.qpic.cn/mmbiz_jpg/Z6bicxIx5naLfE5IUf1f0uWNiaV93g0WxicIHAc3wf3tniaLSP1XYpdncc4T7hwNiaiaDAnbh5d0DPB3Z5BJ6xRvlpFA/640?wx_fmt=jpeg&tp=webp&wxfrom=5&wx_lazy=1#imgIndex=0)
...
> 上下文：你的日历信息（显示你日程已满）、你与此人的过往邮件（用于确定合适的非正式语气）、你的联系人列表（用于识别 ta 为关键的合作伙伴）、send\_invite 或 send\_email 工具。
> 
